    ...
    <div className="auth-page">
      <div className="auth-card">
        ...
        <div className="auth-right">
          <button type="submit" className="primary-btn" onClick={handleLoginSubmit}>
            Login
          </button>
          <p className="auth-link">
            Don't have an account? <button onClick={props.onGoToSignup}>Sign Up</button>
          </p>
          <p className="auth-link">
            Forgot password? <button onClick={props.onGoToForgotPassword}>Reset</button>
          </p>
